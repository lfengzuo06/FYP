"""
Inference pipeline for Plain U-Net on 3-Compartment DEXSY.

This module provides the standard inference interface for the Plain U-Net 3C model,
...
from .model import PlainUNet3C


@dataclass
class PredictionResultPlain3C:
...
class InferencePipelinePlain3C:
    """
    Standard inference pipeline for Plain U-Net 3C.

    This class implements the unified interface required by the benchmark framework:
    - __init__(checkpoint_path=None)
    - predict(signal) -> PredictionResultPlain3C
    - get_model_name() -> str
    - get_model_info() -> dict
    """

    MODEL_NAME = "plain_unet_3c"
    ...
    def get_model_info(self) -> dict:
        ...
        return {
            **self.model_metadata,
            "model_type": "Plain U-Net 3C",
            "description": "CNN baseline U-Net for 3-compartment DEXSY",
    ...
    def predict(
        ...
        *,
        ...
        Returns:
            PredictionResultPlain3C with spectrum, DEI, metrics, and optional figure
        """
        ...
        return PredictionResultPlain3C(
            signal=signal_2d,
    ...
    def predict_batch(
        ...
        *,
        ...
        Returns:
            List of PredictionResultPlain3C objects
        """
        ...
        for idx, reconstructed in enumerate(predictions):
            ...
            results.append(PredictionResultPlain3C(
                signal=signal_2d,
                reconstructed_spectrum=reconstructed,
                dei=float(summary["dei"]),
                summary_metrics=summary,
...
def predict(
    ...
    *,
    ...
    """
    High-level inference function for Plain U-Net 3C.
    ...
    Returns:
        PredictionResultPlain3C with prediction details
    """
    pipeline = InferencePipelinePlain3C(
...
def predict_batch(
    ...
    *,
    ...
    """
    High-level batch inference function for Plain U-Net 3C.
...
if __name__ == "__main__":
    ...
    print("Testing InferencePipelinePlain3C...")

    fm = ForwardModel2D()
    f, s, params = fm.generate_sample(n_compartments=3)

    print(f"  Model: {InferencePipelinePlain3C.MODEL_NAME}")
