"""
Physics-Informed Neural Network (PINN) model for 2D DEXSY.
...
Architecture: Simplified encoder-decoder with physics-informed loss
"""
...
class PINN2D(nn.Module):
    """
    Physics-Informed Neural Network for 2D DEXSY Inversion.
...
class PINNLoss(nn.Module):
    """
    Physics-Informed Loss for PINN on DEXSY.
