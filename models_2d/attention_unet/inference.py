"""
Inference pipeline for Attention U-Net on 2D DEXSY.

This module provides the standard inference interface for the Attention U-Net model,
...
Usage:
    ...
    # Or directly:
    from models_2d.attention_unet import predict
...
from .model import AttentionUNet2D
...
class InferencePipeline:
    """
    Standard inference pipeline for Attention U-Net.
    ...
    DEFAULT_CHECKPOINT = "attention_unet_best_model_20260411_155746.pt"
    ...
    def _find_default_checkpoint(self) -> Path | None:
        ...
        possible_paths = [
            ...
            Path(__file__).parent.parent.parent / "checkpoints" / "attention_unet_best_model.pt",
        ]
    ...
    def get_model_info(self) -> dict:
        ...
        return {
            **self.model_metadata,
            ...
            "description": "U-Net with attention gates and physics-informed loss",
            "paper_reference": "Section 2.4.2 in steven_submission.pdf",
        }
...
def predict_batch(
    ...
    *,
    ...
    """
    High-level batch inference function for Attention U-Net.
